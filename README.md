...
- Расчёт индикаторов и стратегии на ≥1e6 баров менее чем за 1.5 секунды (1 поток, ~3.0 GHz) при окнах ≤64.
- Бэктест прогон 200k баров с одной стратегией <0.8 секунды; 80% запусков CLI <0.5 секунды.
- Память: <200 MB на 1e6 баров (инкрементальные окна, без дублирования серий).
